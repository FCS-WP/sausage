...
Please install and activate it before starting to use the theme EasyEat.
...
Theme documentation is available on https://easyeat.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in EasyEat is Fontello.
