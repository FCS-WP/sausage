...
if ( ! function_exists( 'easyeat_storage_get' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_get( $var_name, $default = '' ) {
		global $EASYEAT_STORAGE;
		return isset( $EASYEAT_STORAGE[ $var_name ] ) ? $EASYEAT_STORAGE[ $var_name ] : $default;
	}
}

if ( ! function_exists( 'easyeat_storage_set' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_set( $var_name, $value ) {
		global $EASYEAT_STORAGE;
		$EASYEAT_STORAGE[ $var_name ] = $value;
	}
}

if ( ! function_exists( 'easyeat_storage_empty' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_empty( $var_name, $key = '', $key2 = '' ) {
		global $EASYEAT_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return empty( $EASYEAT_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return empty( $EASYEAT_STORAGE[ $var_name ][ $key ] );
		} else {
			return empty( $EASYEAT_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'easyeat_storage_isset' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_isset( $var_name, $key = '', $key2 = '' ) {
		global $EASYEAT_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return isset( $EASYEAT_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return isset( $EASYEAT_STORAGE[ $var_name ][ $key ] );
		} else {
			return isset( $EASYEAT_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'easyeat_storage_unset' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_unset( $var_name, $key = '', $key2 = '' ) {
		global $EASYEAT_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			unset( $EASYEAT_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			unset( $EASYEAT_STORAGE[ $var_name ][ $key ] );
		} else {
			unset( $EASYEAT_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'easyeat_storage_inc' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_inc( $var_name, $value = 1 ) {
		global $EASYEAT_STORAGE;
		if ( empty( $EASYEAT_STORAGE[ $var_name ] ) ) {
			$EASYEAT_STORAGE[ $var_name ] = 0;
		}
		$EASYEAT_STORAGE[ $var_name ] += $value;
	}
}

if ( ! function_exists( 'easyeat_storage_concat' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_concat( $var_name, $value ) {
		global $EASYEAT_STORAGE;
		if ( empty( $EASYEAT_STORAGE[ $var_name ] ) ) {
...
if ( ! function_exists( 'easyeat_storage_get_array' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_get_array( $var_name, $key, $key2 = '', $default = '' ) {
		global $EASYEAT_STORAGE;
		if ( '' === $key2 ) {
			return ! empty( $var_name ) && '' !== $key && isset( $EASYEAT_STORAGE[ $var_name ][ $key ] ) ? $EASYEAT_STORAGE[ $var_name ][ $key ] : $default;
		} else {
			return ! empty( $var_name ) && '' !== $key && isset( $EASYEAT_STORAGE[ $var_name ][ $key ][ $key2 ] ) ? $EASYEAT_STORAGE[ $var_name ][ $key ][ $key2 ] : $default;
		}
	}
}

if ( ! function_exists( 'easyeat_storage_set_array' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_set_array( $var_name, $key, $value ) {
		global $EASYEAT_STORAGE;
		if ( ! isset( $EASYEAT_STORAGE[ $var_name ] ) ) {
			$EASYEAT_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$EASYEAT_STORAGE[ $var_name ][] = $value;
		} else {
...
if ( ! function_exists( 'easyeat_storage_set_array2' ) ) {
	/**
	 ...
	 * @param mixed  $value     A new value for the specified element of the array.
	 */
	function easyeat_storage_set_array2( $var_name, $key, $key2, $value ) {
		global $EASYEAT_STORAGE;
		if ( ! isset( $EASYEAT_STORAGE[ $var_name ] ) ) {
			$EASYEAT_STORAGE[ $var_name ] = array();
		}
		if ( ! isset( $EASYEAT_STORAGE[ $var_name ][ $key ] ) ) {
			$EASYEAT_STORAGE[ $var_name ][ $key ] = array();
		}
		if ( '' === $key2 ) {
			$EASYEAT_STORAGE[ $var_name ][ $key ][] = $value;
		} else {
			$EASYEAT_STORAGE[ $var_name ][ $key ][ $key2 ] = $value;
		}
	}
}

if ( ! function_exists( 'easyeat_storage_merge_array' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_merge_array( $var_name, $key, $value ) {
		global $EASYEAT_STORAGE;
		if ( ! isset( $EASYEAT_STORAGE[ $var_name ] ) ) {
			$EASYEAT_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$EASYEAT_STORAGE[ $var_name ] = array_merge( $EASYEAT_STORAGE[ $var_name ], $value );
		} else {
			$EASYEAT_STORAGE[ $var_name ][ $key ] = array_merge( $EASYEAT_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'easyeat_storage_set_array_after' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_set_array_after( $var_name, $after, $key, $value = '' ) {
		global $EASYEAT_STORAGE;
		if ( ! isset( $EASYEAT_STORAGE[ $var_name ] ) ) {
			$EASYEAT_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			easyeat_array_insert_after( $EASYEAT_STORAGE[ $var_name ], $after, $key );
		} else {
			easyeat_array_insert_after( $EASYEAT_STORAGE[ $var_name ], $after, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'easyeat_storage_set_array_before' ) ) {
	/**
	 * Insert new elements to the array in the global theme storage
	 ...
	 * @param mixed        $value     A new value to insert (if the argument $key is a string).
	 */
	function easyeat_storage_set_array_before( $var_name, $before, $key, $value = '' ) {
		global $EASYEAT_STORAGE;
		if ( ! isset( $EASYEAT_STORAGE[ $var_name ] ) ) {
			$EASYEAT_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			easyeat_array_insert_before( $EASYEAT_STORAGE[ $var_name ], $before, $key );
		} else {
			easyeat_array_insert_before( $EASYEAT_STORAGE[ $var_name ], $before, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'easyeat_storage_push_array' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_push_array( $var_name, $key, $value ) {
		global $EASYEAT_STORAGE;
		if ( ! isset( $EASYEAT_STORAGE[ $var_name ] ) ) {
			$EASYEAT_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			array_push( $EASYEAT_STORAGE[ $var_name ], $value );
		} else {
			if ( ! isset( $EASYEAT_STORAGE[ $var_name ][ $key ] ) ) {
				$EASYEAT_STORAGE[ $var_name ][ $key ] = array();
			}
			array_push( $EASYEAT_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'easyeat_storage_pop_array' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_pop_array( $var_name, $key = '', $defa = '' ) {
		global $EASYEAT_STORAGE;
		$rez = $defa;
		if ( '' === $key ) {
			if ( isset( $EASYEAT_STORAGE[ $var_name ] ) && is_array( $EASYEAT_STORAGE[ $var_name ] ) && count( $EASYEAT_STORAGE[ $var_name ] ) > 0 ) {
				$rez = array_pop( $EASYEAT_STORAGE[ $var_name ] );
			}
		} else {
			if ( isset( $EASYEAT_STORAGE[ $var_name ][ $key ] ) && is_array( $EASYEAT_STORAGE[ $var_name ][ $key ] ) && count( $EASYEAT_STORAGE[ $var_name ][ $key ] ) > 0 ) {
				$rez = array_pop( $EASYEAT_STORAGE[ $var_name ][ $key ] );
			}
		}
		return $rez;
	}
...
if ( ! function_exists( 'easyeat_storage_inc_array' ) ) {
	/**
	 ...
	 * @param int          $value     Optional. A value for increment. Default is 1. Specify -1 to decrement or any legal number value.
	 */
	function easyeat_storage_inc_array( $var_name, $key, $value = 1 ) {
		global $EASYEAT_STORAGE;
		if ( ! isset( $EASYEAT_STORAGE[ $var_name ] ) ) {
			$EASYEAT_STORAGE[ $var_name ] = array();
		}
		if ( empty( $EASYEAT_STORAGE[ $var_name ][ $key ] ) ) {
			$EASYEAT_STORAGE[ $var_name ][ $key ] = 0;
		}
		$EASYEAT_STORAGE[ $var_name ][ $key ] += $value;
	}
}

if ( ! function_exists( 'easyeat_storage_concat_array' ) ) {
	/**
	 ...
	 * @param int          $value     A value to concatenate.
	 */
	function easyeat_storage_concat_array( $var_name, $key, $value ) {
		global $EASYEAT_STORAGE;
		if ( ! isset( $EASYEAT_STORAGE[ $var_name ] ) ) {
			$EASYEAT_STORAGE[ $var_name ] = array();
		}
		if ( empty( $EASYEAT_STORAGE[ $var_name ][ $key ] ) ) {
			$EASYEAT_STORAGE[ $var_name ][ $key ] = '';
		}
		$EASYEAT_STORAGE[ $var_name ][ $key ] .= $value;
	}
}

if ( ! function_exists( 'easyeat_storage_call_obj_method' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_call_obj_method( $var_name, $method, $param = null ) {
		global $EASYEAT_STORAGE;
		if ( null === $param ) {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $EASYEAT_STORAGE[ $var_name ] ) ? $EASYEAT_STORAGE[ $var_name ]->$method() : '';
		} else {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $EASYEAT_STORAGE[ $var_name ] ) ? $EASYEAT_STORAGE[ $var_name ]->$method( $param ) : '';
		}
	}
}

if ( ! function_exists( 'easyeat_storage_get_obj_property' ) ) {
	/**
	 ...
	 */
	function easyeat_storage_get_obj_property( $var_name, $prop, $default = '' ) {
		global $EASYEAT_STORAGE;
		return ! empty( $var_name ) && ! empty( $prop ) && isset( $EASYEAT_STORAGE[ $var_name ]->$prop ) ? $EASYEAT_STORAGE[ $var_name ]->$prop : $default;
	}
}
