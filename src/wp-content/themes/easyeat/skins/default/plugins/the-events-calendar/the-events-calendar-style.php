...
if ( ! function_exists( 'easyeat_tribe_events_get_css' ) ) {
	add_filter( 'easyeat_filter_get_css', 'easyeat_tribe_events_get_css', 10, 2 );
	function easyeat_tribe_events_get_css( $css, $args ) {
...
.tribe-common .tribe-common-b3 .tribe-events-calendar-month__header-column-title-desktop,
.tribe-common .tribe-common-b3 .tribe-events-calendar-month__header-column-title-mobile {
