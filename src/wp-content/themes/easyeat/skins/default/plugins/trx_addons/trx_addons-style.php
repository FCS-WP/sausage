...
if ( ! function_exists( 'easyeat_trx_addons_get_css' ) ) {
	add_filter( 'easyeat_filter_get_css', 'easyeat_trx_addons_get_css', 10, 2 );
	function easyeat_trx_addons_get_css( $css, $args ) {
...
.sc_icons_plate.sc_icons .sc_icons_item_more_link,
