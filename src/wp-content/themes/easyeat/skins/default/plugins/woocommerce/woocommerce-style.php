...
if ( ! function_exists( 'easyeat_woocommerce_get_css' ) ) {
	add_filter( 'easyeat_filter_get_css', 'easyeat_woocommerce_get_css', 10, 2 );
	function easyeat_woocommerce_get_css( $css, $args ) {
...
$fdir = easyeat_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
