...
if ( ! function_exists( 'easyeat_gutenberg_get_css' ) ) {
	add_filter( 'easyeat_filter_get_css', 'easyeat_gutenberg_get_css', 10, 2 );
	function easyeat_gutenberg_get_css( $css, $args ) {
